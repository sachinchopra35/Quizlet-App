...
Paste these into the matching fields in App Store Connect. Character limits noted where Apple enforces them.
...
```
Useful sentences, offline
```

Alternative:

```
Speak Punjabi, English letters
```
...
```
Learn spoken Punjabi with useful everyday sentences — typed in English letters. No Gurmukhi required. Works fully offline. Built for real conversations, not textbook phrases.
```
...
MADE FOR REAL LIFE
• 80+ levels of practical vocabulary and phrases
• Fully offline — no internet needed after install
• Progress and settings saved on your device
• Forgiving answer matching for natural spelling variations
...
```
punjabi,malwai,learn,speak,phrases,vocabulary,roman,offline,language,india,sentences,practice
```
...
Check App Store Connect for current requirements. Typically:

- **6.7" display** (e.g. iPhone 15 Pro Max simulator)
- **6.5" display** (e.g. iPhone 11 Pro Max simulator)

Capture in Simulator: **File → Save Screen** or **Cmd+S**.
